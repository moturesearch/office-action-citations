'''
This code creates one csv file for each tsv file (that Emma gave me).
The csv file contains two columns: label, md5_id.

Note - this is for all citations (whereas classify02.py is only for biblio citations). 
'''
